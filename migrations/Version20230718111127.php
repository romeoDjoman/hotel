 ...
 */
final class Version20230718111127 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE commande (id INT AUTO_INCREMENT NOT NULL, chambre_id INT NOT NULL, date_arrivee DATE NOT NULL, date_depart DATE NOT NULL, prix_total INT NOT NULL, prenom VARCHAR(20) NOT NULL, nom VARCHAR(20) NOT NULL, telephone VARCHAR(255) NOT NULL, email VARCHAR(50) NOT NULL, date_enregistrement DATETIME NOT NULL, INDEX IDX_6EEAA67D9B177F54 (chambre_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
